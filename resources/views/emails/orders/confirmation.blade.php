...
@section('content')
    {{-- Customer --}}
    <div style="font-family:'Helvetica Neue',Arial,sans-serif; font-size:11px; letter-spacing:0.2em; text-transform:uppercase; color:#B8860B; font-weight:600; margin-bottom:10px;">Your details</div>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
        ...
        <tr><td style="padding:5px 0; color:#777; font-size:11px; letter-spacing:0.18em; text-transform:uppercase;">Email</td><td style="padding:5px 0;">{{ $customerEmail }}</td></tr>
        <tr><td style="padding:5px 0; color:#777; font-size:11px; letter-spacing:0.18em; text-transform:uppercase;">Phone</td><td style="padding:5px 0;">{{ $customerPhone }}</td></tr>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
        <tr><td style="padding:6px 0; color:#777; font-size:11px; letter-spacing:0.18em; text-transform:uppercase; width:40%;">Number</td><td style="padding:6px 0; font-family:'Helvetica Neue',Arial,sans-serif; font-weight:600; letter-spacing:0.02em;">#{{ $orderNumber }}</td></tr>
        ...
        @if($notes)
        <tr><td style="padding:6px 0; color:#777; font-size:11px; letter-spacing:0.18em; text-transform:uppercase;">Notes</td><td style="padding:6px 0; font-style:italic; color:#555;">{{ $notes }}</td></tr>
        @endif
    </table>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:18px;">
        ...
        <tr><td style="padding:4px 0; color:#555;">Tax (HST)</td><td style="padding:4px 0; text-align:right;">${{ $tax }}</td></tr>
        @if($deliveryFee > 0)
        <tr><td style="padding:4px 0; color:#555;">Delivery fee</td><td style="padding:4px 0; text-align:right;">${{ $deliveryFee }}</td></tr>
        @endif
        @if(isset($tipAmount) && $tipAmount > 0)
        <tr><td style="padding:4px 0; color:#555;">Tip</td><td style="padding:4px 0; text-align:right;">${{ $tipAmount }}</td></tr>
        @endif
    ...
    <p style="margin-top:32px; font-size:13px; color:#777; text-align:center;">Questions? Call us at <a href="tel:{{ $restaurantPhone }}" style="color:#B8381F;">{{ $restaurantPhone }}</a> or visit us at {{ $restaurantAddress }}.</p>
@endsection
